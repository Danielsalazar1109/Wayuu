...
export const products: Product[] = [
  {
    ...
    description:
      "Mochila Wayuu tejida a mano en telar. Diseño inspirado en las tramas geométricas del Caribe colombiano. Incluye borla y correa tejida para llevar al hombro.",
  ...
  },
  {
    ...
    shortDescription: "Tonos tierra con acentos dorados, perfecta para uso diario.",
    description:
      "Una mochila versátil con paleta ocre y detalles en negro. Tejida a mano por artesanas Wayuu, con acabados resistentes y una caída suave.",
    size: "28 cm (H) × 21 cm (W)",
  },
  {
    slug: "golden-radiance-clutch-bag",
    name: "Golden Radiance Wayuu Clutch Bag",
